...
/**
* Per Jeff at Simplay Accessible - OK to comment goog.getMsg out. Currently conflicts with Wishabi 
...
vjs.removeClass = function(element, classToRemove){
  ...
  var classNames = element.className.split(' ' + classToRemove);
...
vjs.Player = function(tag, options, ready){
  ...
  // Set labels
  this.labels_ = options['labels'] || this.options_.labels;
  // Set image sprit
  this.image_ = options['image'] || this.options_.image;
...
vjs.ControlBar = function(player, options){
  ...
  player.one('play', vjs.bind(this, function(){
    ...
    if ( !('ontouchstart' in window) ) {
      this.player_.on('mouseover', vjs.bind(this, this.lockShowing));
      this.player_.on('mouseout', vjs.bind(this, this.lockShowing));
...
vjs.Button.prototype.createEl = function(type, props){
  ...
  props = vjs.obj.merge({
    ...
    innerHTML: '<div class="vjs-control-text">' + (this.player_.labels_[this.label] || this.buttonText || 'Need Text') + '</div><span><img src="' + this.player_.image_ + '" alt=""></span>',
...
vjs.PlayButton.prototype.createEl = function(type, props){
  // Add standard Aria and Tabindex info
  ...
  return goog.base(this, 'createEl', 'button', props);
};
vjs.PlayButton.prototype.label = 'play';
...
vjs.PauseButton.prototype.createEl = function(type, props){
  // Add standard Aria and Tabindex info
  var player = this.player();
  props = vjs.obj.merge({
    className: this.buildCSSClass(),
...
vjs.PlayButton.prototype.label = 'pause';
vjs.PauseButton.prototype.buttonText = 'Pause';
...
vjs.PlayToggle.prototype.createEl = function(type, props){
  // Add standard Aria and Tabindex info
  var player = this.player();
  props = vjs.obj.merge({
    className: this.buildCSSClass(),
...
vjs.PlayToggle.prototype.onPlay = function(){
  vjs.removeClass(this.el_, 'vjs-paused');
  vjs.addClass(this.el_, 'vjs-playing');
  this.el_.children[0].innerHTML = (this.player_.labels_.pause || 'Pause'); // change the button text to "Pause"
};
...
vjs.PlayToggle.prototype.onPause = function(){
  vjs.removeClass(this.el_, 'vjs-playing');
  vjs.addClass(this.el_, 'vjs-paused');
  this.el_.children[0].innerHTML = (this.player_.labels_.play || 'Play'); // change the button text to "Play"
};
...
vjs.FullscreenToggle.prototype.createEl = function(type, props){
  // Add standard Aria and Tabindex info
  var player = this.player();
  props = vjs.obj.merge({
    className: this.buildCSSClass(),
...
vjs.FullscreenToggle.prototype.label = 'fullscreen';
...
vjs.FullscreenToggle.prototype.onClick = function(){
  if (!this.player_.isFullScreen) {
    ...
    this.el_.children[0].innerHTML = (this.player_.labels_.nonfullscreen || 'Non-Fullscreen'); // change the button text to "Non-Fullscreen"
  } else {
    this.player_.cancelFullScreen();
    this.el_.children[0].innerHTML = (this.player_.labels_.fullscreen || 'Fullscreen'); // change the button to "Fullscreen"
  }
};
...
vjs.BigPlayButton.prototype.createEl = function(type, props){
  // Add standard Aria and Tabindex info
  var player = this.player();
  props = vjs.obj.merge({
    className: 'vjs-big-play-button',
    innerHTML: '<div class="vjs-control-text">' + (this.player_.labels_.play || this.buttonText || 'Need Text') + '</div><span><img src="' + this.player_.image_ + '" alt=""></span>',
    'aria-live': 'polite' // let the screen reader user know that the text of the button may change
  }, props);
...
vjs.CurrentTimeDisplay.prototype.createEl = function(){
  ...
  this.content = vjs.createEl('div', {
    ...
    innerHTML: '<span class="vjs-control-text">' + (this.player_.labels_.current_time || 'Current Time') + ' </span>' + '0:00', // label the current time for screen reader users
...
vjs.CurrentTimeDisplay.prototype.updateContent = function(){
  ...
  this.content.innerHTML = '<span class="vjs-control-text">' + (this.player_.labels_.current_time || 'Current Time') + ' </span>' + vjs.formatTime(time, this.player_.duration());
};
...
vjs.DurationDisplay.prototype.createEl = function(){
  ...
  this.content = vjs.createEl('div', {
    ...
    innerHTML: '<span class="vjs-control-text">' + (this.player_.labels_.duration_time || 'Duration Time') + ' </span>' + '0:00', // label the duration time for screen reader users
    'aria-live': 'off' // tell screen readers not to automatically read the time as it changes
  });
...
vjs.DurationDisplay.prototype.updateContent = function(){
  if (this.player_.duration()) {
      this.content.innerHTML = '<span class="vjs-control-text">' + (this.player_.labels_.duration_time || 'Duration Time') + ' </span>' + vjs.formatTime(this.player_.duration()); // label the duration time for screen reader users
  }
};
...
vjs.RemainingTimeDisplay.prototype.createEl = function(){
  ...
  this.content = vjs.createEl('div', {
    ...
    innerHTML: '<span class="vjs-control-text">' + (this.player_.labels_.remaining_time || 'Remaining Time') + ' </span>' + '-0:00', // label the remaining time for screen reader users
    'aria-live': 'off' // tell screen readers not to automatically read the time as it changes
  });
...
vjs.RemainingTimeDisplay.prototype.updateContent = function(){
  if (this.player_.duration()) {
      if (this.player_.duration()) {
          this.content.innerHTML = '<span class="vjs-control-text">' + (this.player_.labels_.remaining_time || 'Remaining Time') + ' </span>' + '-'+ vjs.formatTime(this.player_.remainingTime());
      }
  }
...
vjs.SeekBar.prototype.createEl = function(){
  return goog.base(this, 'createEl', 'div', {
    ...
    'aria-label': (this.player_.labels_.video_progress_bar || 'video progress bar')
  });
};
...
vjs.LoadProgressBar.prototype.createEl = function(){
  return goog.base(this, 'createEl', 'div', {
    ...
    innerHTML: '<span class="vjs-control-text">' + (this.player_.labels_.loaded || 'Loaded') + ': 0%</span>'
  });
};
...
vjs.PlayProgressBar.prototype.createEl = function(){
  return goog.base(this, 'createEl', 'div', {
    ...
    innerHTML: '<span class="vjs-control-text">' + (this.player_.labels_.progress || 'Progress') + ': 0%</span>'
  });
};
...
vjs.VolumeBar.prototype.createEl = function(){
  return goog.base(this, 'createEl', 'div', {
    ...
    'aria-label': (this.player_.labels_.volume_level || 'volume level')
  });
};
...
vjs.MuteToggle.prototype.createEl = function(){
  return goog.base(this, 'createEl', 'button', {
...
vjs.MuteToggle.prototype.label = 'mute';
vjs.MuteToggle.prototype.buttonText = 'Mute';
...
vjs.MuteToggle.prototype.update = function(){
  ...
  if(this.player_.muted()){
      if(this.el_.children[0].innerHTML != (this.player_.labels_.unmute || 'Unmute')){
          this.el_.children[0].innerHTML = (this.player_.labels_.unmute || 'Unmute'); // change the button text to "Unmute"
      }
  } else {
      if(this.el_.children[0].innerHTML != (this.player_.labels_.mute || 'Mute')){
          this.el_.children[0].innerHTML = (this.player_.labels_.mute || 'Mute'); // change the button text to "Mute"
      }
  }
...
vjs.Menu.prototype.lockShowing = function(){
  var style = this.el_.style;
  style.display = 'block';
  style.opacity = 1;
  style.visibility = 'visible';
  this.el_.setAttribute('aria-hidden', 'false');
  var title = this.el_.children[0];
  title.tabIndex = -1;
  title.focus(); // set the focus to the title of the submenu
  return this;
};

vjs.Menu.prototype.unlockShowing = function(){
  var style = this.el_.style;
  style.display = '';
  style.opacity = '';
  style.visibility = '';
...
vjs.MenuItem.prototype.selected = function(selected){
  if (selected) {
    this.addClass('vjs-selected');
    this.el_.setAttribute('aria-checked',true);
    this.el_.innerHTML = this.options_.label + '<span class="vjs-control-text"> (' + this.player_.labels_.selected + ')</span>';
  } else {
    this.removeClass('vjs-selected');
    this.el_.setAttribute('aria-checked',false);
    this.el_.innerHTML = this.options_.label;
  }
};
/**
...
vjs.TextTrackMenuItem.prototype.onKeyPress = function(e){
    if(e.keyCode === 13 || e.keyCode === 32){
        goog.base(this, 'onKeyPress');
        this.player_.showTextTrack(this.track.id_, this.track.kind());
    }
};
...
vjs.OffTextTrackMenuItem = function(player, options){
  ...
  options['track'] = {
    ...
    player: player,
    label: function(){ return (player.labels_.off || 'Off'); },
...
vjs.TextTrackButton.prototype.createEl = function(){
  return goog.base(this, 'createEl', 'div', {
    className: this.buildCSSClass(),
    innerHTML: '<span><img src="' + this.player_.image_ + '" alt="' + (this.player_.labels_[this.label] || this.buttonText || 'Need Text') + '"></span>',
    'aria-live': 'polite' // let the screen reader user know that the text of the button may change
  });
};
...
vjs.TextTrackButton.prototype.createMenu = function(){
  ...
  menu.el().appendChild(vjs.createEl('li', {
    ...
    innerHTML: (this.player_.labels_[this.label] || this.kind_),
    tabindex: -1
  }));
...
vjs.TextTrackButton.prototype.onKeyPress = function(event){
  ...
  if (event.which == 27){
    ...
    if(this.el_.children[1].getAttribute('aria-hidden') === 'false'){
        ...
        if (event.which == 39 || event.which == 40){
            ...
            jQuery(el).nextAll('li:visible[role="menuitemradio"]').first().focus();
        }
        ...
        if (event.which == 37 || event.which == 38){
            ...
            jQuery(el).prevAll('li:visible[role="menuitemradio"]').first().focus();
        }
    }
};
...
vjs.CaptionsButton = function(player, options, ready){
  goog.base(this, player, options, ready);
  this.el_.setAttribute('aria-label',(this.player_.labels_.captions_menu || 'Captions Menu'));
};
goog.inherits(vjs.CaptionsButton, vjs.TextTrackButton);
vjs.CaptionsButton.prototype.kind_ = 'captions';
vjs.CaptionsButton.prototype.label = 'captions';
...
vjs.SubtitlesButton = function(player, options, ready){
  goog.base(this, player, options, ready);
  this.el_.setAttribute('aria-label',(this.player_.labels_.subtitles_menu || 'Subtitles Menu'));
};
goog.inherits(vjs.SubtitlesButton, vjs.TextTrackButton);
vjs.SubtitlesButton.prototype.kind_ = 'subtitles';
vjs.SubtitlesButton.prototype.label = 'subtitles';
...
vjs.ChaptersButton = function(player, options, ready){
  goog.base(this, player, options, ready);
  this.el_.setAttribute('aria-label',(this.player_.labels_.chapters_menu || 'Chapters Menu'));
};
goog.inherits(vjs.ChaptersButton, vjs.TextTrackButton);
vjs.ChaptersButton.prototype.kind_ = 'chapters';
vjs.ChaptersButton.prototype.label = 'chapters';
