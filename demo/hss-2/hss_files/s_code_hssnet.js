...
var s_account="gpaperhssnet"
var s_hssnet=s_gi(s_account)
/************************** CONFIG SECTION **************************/
/* You may add or alter any code config here. */
s_hssnet.charSet="UTF-8"
/* Conversion Config */
s_hssnet.currencyCode="USD"
/* Link Tracking Config */
s_hssnet.trackDownloadLinks=true
s_hssnet.trackExternalLinks=true
s_hssnet.trackInlineStats=true
s_hssnet.linkDownloadFileTypes="exe,zip,wav,mp3,mov,mpg,avi,wmv,pdf,doc,docx,xls,xlsx,ppt,pptx"
s_hssnet.linkInternalFilters="javascript:,HighSchoolSports.net,Dev.highschoolsports.net,Dev6.highschoolsports.net,Stage.highschoolsports.net,StageTest.highschoolsports.net,Stagingwww.highschoolsports.net"
s_hssnet.linkLeaveQueryString=false
s_hssnet.linkTrackVars="None"
s_hssnet.linkTrackEvents="None"

/* WARNING: Changing any of the below variables will cause drastic
changes to how your visitor data is collected.  Changes should only be
made when instructed to do so by your account manager.*/
s_hssnet.trackingServer="gannett.112.2o7.net"
