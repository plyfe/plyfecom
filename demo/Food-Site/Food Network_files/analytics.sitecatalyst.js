	        ...
	        var s_account = "scrippsfoodnetnew";
        ...
        s.linkInternalFilters= '\"javascript:,foodnetwork.com,scrippsnetworks.com\"';
        s.trackDownLoadLinks= true;
...
if (s.eVar41){s.events=s.apl(s.events,"event28",",",2);}
...
if (s.prop46 != "" && s.prop7 != "") {s.prop47=s.prop46 + "-" + s.prop7;}
...
if (s.prop10 == "recipe-print" || s.prop10 == "recipe_print") {s.events=s.apl(s.events,"event11",",",2);}
