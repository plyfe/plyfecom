...
var ci_vid = 841291;
var ci_cookieDomain = ".walmart.com";
var ci_refDomain = ".walmart.com";
var ci_testDomain = "www-qa2.walmart.com";
var ci_imgs = [];
...
try{
    ...
    var sku = ci_RQV('product_id');
	
	//Marketing programs detected by adid= or sourceid=
	var ci_adid=ci_RQV('adid');
	var ci_sourceid=ci_RQV('sourceid');
	if(ci_cpncode===null && (ci_src===null && ci_sku===null) && ci_adid !== null){
		ci_tag=ci_adid;
	}
	if(ci_cpncode===null && (ci_src===null && ci_sku===null) && ci_sourceid !== null){
		ci_tag=ci_sourceid;
	}
    ...
    } else if (document.referrer.toLowerCase().indexOf(ci_refDomain) === -1 && document.referrer.toLowerCase().indexOf(ci_testDomain) === -1 && document.referrer !== '') {
